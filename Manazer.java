    ...
    private class ManazerKlaves extends KeyAdapter {
        public void keyPressed(KeyEvent event) {
            if (event.getKeyCode() == KeyEvent.VK_DOWN) {
                Manazer.this.posliSpravu("pohybDole");
            } else if (event.getKeyCode() == KeyEvent.VK_UP) {
                Manazer.this.posliSpravu("pohybHore");
            } else if (event.getKeyCode() == KeyEvent.VK_LEFT) {
                Manazer.this.posliSpravu("pohybVlavo");
            } else if (event.getKeyCode() == KeyEvent.VK_RIGHT) {
                Manazer.this.posliSpravu("pohybVpravo");
            } else if (event.getKeyCode() == KeyEvent.VK_SPACE || event.getKeyCode() == KeyEvent.VK_ENTER) {
                Manazer.this.posliSpravu("vyskoc");
            } else if (event.getKeyCode() == KeyEvent.VK_ESCAPE) {
                Manazer.this.posliSpravu("stopniHru");
            } else if (event.getKeyCode() == KeyEvent.VK_V) {
                Manazer.this.posliSpravu("stlaceneV");
            }
        }
        
        @Override public void keyReleased(KeyEvent pustilSi) {
            Manazer.this.posliSpravu("hracSaNepohybuje");
        }
    }
