...
public class Platno {
    ...
    public static Platno dajPlatno() {
        if (Platno.platnoSingleton == null) {
            Platno.platnoSingleton = new Platno("Mario", 1650, 850,
                                                new Color(80, 135, 252));
        }
    ...
    private Color trava = new Color(117, 217, 0);
    private Color obloha = new Color(80, 135, 252);
    private Font sansSerifFont = new Font("SansSerif", Font.PLAIN, 12);
    ...
    private Platno(String titulok, int sirka, int vyska, Color pozadie) {
        try {
            this.image = ImageIO.read(getClass().getResourceAsStream("\\charakter\\pozadieHry.png"));
        } catch (Exception e) { } 
        ...
        this.timer = new javax.swing.Timer(30, null);
        this.timer.start();
    ...
    public void setForegroundColor(String farba) {
        if (farba.equals("red")) {
            ...
            this.graphic.setColor(this.trava);
    ...
    private void erase() {
        ...
        //this.graphic.drawImage(image, 0, 0, null);
    }
